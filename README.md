...
Securely install the latest [pdm](https://pypi.org/project/pdm/) release from PyPI.

This action installs a pinned version of **pdm** and all its dependencies,         making sure that file hashes match. Pinning your dependencies:
...
```yaml
      - name: Install pdm from PyPI
        uses: install-pinned/pdm@1deb6d765ae1c935b1d11523b9a2305bf4d276f7  # 2.20.0.post1
```
